...
class LatLonSpherical {
  constructor(lat, lon) {
    ...
    this._lat = _dms.default.wrap90(lat);
    this._lon = _dms.default.wrap180(lon);
  }
  ...
  set lat(lat) {
    this._lat = isNaN(lat) ? _dms.default.wrap90(_dms.default.parse(lat)) : _dms.default.wrap90(lat);
  ...
  set lon(lon) {
    this._lon = isNaN(lon) ? _dms.default.wrap180(_dms.default.parse(lon)) : _dms.default.wrap180(lon);
