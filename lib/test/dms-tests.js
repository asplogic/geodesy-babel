...
describe('dms', function () {
  ...
  describe('parse variations', function () {
    // including whitespace, different d/m/s symbols (ordinal, ascii/typo quotes)
    const variations = ['45.76260', '45.76260 ', '45.76260°', '45°45.756′', '45° 45.756′', '45 45.756', '45°45′45.36″', '45º45\'45.36"', '45°45’45.36”', '45 45 45.36 ', '45° 45′ 45.36″', '45º 45\' 45.36"', '45° 45’ 45.36”'];
  ...
  describe('compass points', function () {
    ...
    test('bad precision', () => should.Throw(function () {
      Dms.compassPoint(0, 0);
    }, RangeError));
  });
  ...
  describe('convert failures', function () {
    ...
    test('output obj', () => should.equal(Dms.toDms({
      a: 1
    }), null));
  ...
  describe('wrap90', function () {
    ...
    test('-360°', () => Dms.wrap90(-360).should.equal(0)); // test('-315°', () => Dms.wrap90(-315).should.equal(  45)); TODO: fix!
