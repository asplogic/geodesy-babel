...
describe('os-gridref', function () {
  ...
  describe('@examples', function () {
    test('Constructor', () => new OsGridRef(651409, 313177).should.deep.equal({
      easting: 651409,
      northing: 313177
    }));
    ...
    test('parse', () => OsGridRef.parse('TG 51409 13177').should.deep.equal({
      easting: 651409,
      northing: 313177
    }));
  ...
  describe('constructor fail', function () {
    test('Invalid northing', () => should.Throw(function () {
      new OsGridRef(0, 1301e3);
    }, Error, 'invalid northing ‘1301000’'));
    test('Invalid easting', () => should.Throw(function () {
      new OsGridRef(701e3, 0);
    }, Error, 'invalid easting ‘701000’'));
    test('texts', () => should.Throw(function () {
      new OsGridRef('e', 'n');
    }, Error, 'invalid easting ‘e’'));
  });
  describe('parse fail', function () {
    test('text', () => should.Throw(function () {
      OsGridRef.parse('Cambridge');
    }, Error, 'invalid grid reference ‘Cambridge’'));
    test('outside range', () => should.Throw(function () {
      OsGridRef.parse('AA 1 2');
    }, Error, 'invalid grid reference ‘AA 1 2’'));
    test('unbalanced numerics', () => should.Throw(function () {
      OsGridRef.parse('SV 1 20');
    }, Error, 'invalid grid reference ‘SV 1 20’'));
  });
  describe('toString fail', function () {
    test('1bad precision', () => should.Throw(function () {
      new OsGridRef(651409, 313177).toString(20);
    }, Error, 'invalid precision ‘20’'));
  });
  ...
  describe('DG round-trip', function () {
    const dgGridRef = OsGridRef.parse('TQ 44359 80653'); // round-tripping OSGB36 works perfectly
