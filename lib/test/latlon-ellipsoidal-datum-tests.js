...
describe('latlon-ellipsoidal-datum', function () {
  ...
  describe('valid datum', function () {
    test('constructor', () => should.Throw(function () {
      new LatLon(0, 0, 0, null);
    }, TypeError, 'unrecognised datum ‘null’'));
    test('parse', () => should.Throw(function () {
  ...
  describe('convert datum (Greenwich)', function () {
    ...
    const greenwichOSGB36 = greenwichWGS84.convertDatum(LatLon.datums.OSGB36); // greenwichOSGB36.height = 0;
    ...
    test('convert fails', () => should.Throw(function () {
      new LatLon(51, 0).convertDatum(null);
    }, TypeError, 'unrecognised datum ‘null’'));
  });
  describe('convert datum (Petroleum Operations Notices)', function () {
    ...
    test('convert WGS84 -> OSGB36', () => new LatLon(53, 1, 50).convertDatum(LatLon.datums.OSGB36).toString('dms', 3, 2).should.equal('52°59′58.719″N, 001°00′06.490″E +3.99m')); // https://www.gov.uk/guidance/oil-and-gas-petroleum-operations-notices#test-point-using-common-offshore-transformation-parameters
  ...
  describe('cartesian', function () {
    ...
    test('toLatLon fail', () => should.Throw(function () {
      c.toLatLon('xx');
    }, TypeError, 'unrecognised datum ‘xx’'));
  });
});